...
<div class="row">
	<div class="col-md-10">
		<img width="500" class="pull-right" src="/research/images/cancer_evolution.png">
		<div class="post">
			<p>
...
<div class="row">
	<div class="col-md-10">
		<img width="500" class="pull-right" src="/research/images/single_cell_genomics.png">
		<div class="post">
			<p>
...
<div class="row">
	<div class="col-md-10">
		<img width="500" class="pull-right" src="/research/images/bioinformatics_software.png">
		<div class="post">
			<p>
			...
			<p>	
				...
				<a href="http://shahlab.ca/papers/21625565">deFuse: an algorithm for gene fusion discovery in tumor RNA-Seq data</a>
...
<div class="row">
	<div class="col-md-10">
		<img width="500" class="pull-right" src="/research/images/mutational_signature.png">
		<div class="post">
			<p>
...
<div class="row">
	<div class="col-md-10">
		<img width="500" class="pull-right" src="/research/images/drug_response.png">
		<div class="post">
			<p>
